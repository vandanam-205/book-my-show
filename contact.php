...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s" style="background-image: url('img/contact.jpg'); background-size: cover, auto; width: 100%; height: 450px; justify-content: center; padding: 0%; margin-top:10px; padding-top: 25px;">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight" style="margin-top:50px; justify-content: center;">Contact</h1>
            ...
            <div class="row g-5 justify-content-center mb-5">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <p class="mb-2">bookmyshow@example.com</p>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6">
                            <div class="d-flex">
                                ...
                                <div class="ms-3">
                                    <h6>Mail Us</h6>
                                    <span>bookmyshow@example.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
